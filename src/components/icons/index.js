...
export const Custom = ({ icon, size, animation, duration, color, onPress, style }) => {
        ...
        <Animatable.View animation={animation} duration={duration}>
            <TouchableOpacity disabled={!onPress} onPress={onPress}>
                <Image
                    source={icon}
                    resizeMode="contain"
                    style={[{ height: size ? size : defaulSize, width: size ? size : defaulSize, tintColor: color }, style]}
                />
            </TouchableOpacity>
        </Animatable.View>
    );

...
export const Colored = ({
    ...
    return (
        <TouchableOpacity onPress={onPress} disabled={isLoading ? true : disabled}>
            <Wrappers.Primary animation={animation} style={[appStyles.buttonColord, { borderRadius: sizes.buttonRadius, height: height(7), backgroundColor: disabled ? colors.primary + '80' : buttonColor ? buttonColor : colors.primary }, buttonStyle]}>
...
export const Bordered = ({ text, onPress, buttonStyle, textStyle, iconName, customIcon, iconType, iconSize, iconColor, iconStyle, tintColor }) => {
    return (
        <TouchableOpacity onPress={onPress} style={[appStyles.buttonBorderd, { borderRadius: sizes.buttonRadius, height: height(7), borderColor: tintColor ? tintColor : colors.gold }, buttonStyle]}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                ...
                <Texts.ButtonMedium style={[{ color: tintColor ? tintColor : colors.snow, }, textStyle]}>{text}</Texts.ButtonMedium>
            </View>
        </TouchableOpacity>
    );
}
